...
| SC-05    | Third-party libraries (Maven-dependencies)                   | Infrastructuur        | **Midden**   | C: Midden / I: Midden / A: Midden    | `pom.xml` projectroot; zie `sbom/sbom-1.17.0-SNAPSHOT-2026-06-19.json` (pipeline-artifact)                                           | Verouderde libraries met bekende CVE's vormen een indirect risico; zie SBOM (taak 1.4 / 2.4)                                             |
